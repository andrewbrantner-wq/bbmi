...
const BADGES: Record<string, { name: string; gradient: string; desc: string; icon: string }> = {
  'Fortress': {
    name: "Fortress",
    gradient: "linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%)", // Deep blue to bright blue
  ...
  'Arc Defenders': {
    name: "Arc Defenders",
    gradient: "linear-gradient(135deg, #047857 0%, #10b981 100%)", // Dark green to emerald
  ...
  'Sharpshooters': {
    name: "Sharpshooters",
    gradient: "linear-gradient(135deg, #7c3aed 0%, #a855f7 100%)", // Deep purple to violet
  ...
  'Balanced': {
    name: "Balanced",
    gradient: "linear-gradient(135deg, #475569 0%, #64748b 100%)", // Slate gray
    desc: "Well-rounded excellence",
    icon: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z M8 12h8M12 8v8"
  },
  'Glass Cleaners': {
    name: "Glass Cleaners",
    gradient: "linear-gradient(135deg, #0f766e 0%, #14b8a6 100%)", // Dark teal to teal
  ...
  'Pickpockets': {
    name: "Pickpockets",
    gradient: "linear-gradient(135deg, #b91c1c 0%, #dc2626 100%)", // Dark red to red
  ...
  'Giant Slayers': {
    name: "Giant Slayers",
    gradient: "linear-gradient(135deg, #ca8a04 0%, #eab308 100%)", // Dark yellow to yellow (gold)
  ...
  'Battle-Tested': {
    name: "Battle-Tested",
    gradient: "linear-gradient(135deg, #334155 0%, #475569 100%)", // Dark slate gray
...
export function TeamBadges({ primaryBadge, secondaryBadges = [] }: {
  primaryBadge: string;
...
export enum Badge {} // Empty enum for TypeScript compatibility