  ...
  return (
    <Link href={href} className="block w-full">
      ...
      >
        ...
        {/* Stats row — stacked on tiny screens, inline on larger */}
        <div style={{
          display: "flex",
          flexDirection: "column",
          gap: "0.2rem",
          ...
          <div style={{ display: "flex", justifyContent: "space-around", gap: "0.5rem" }}>
            <div style={{ textAlign: "center" }}>
              ...
              <div style={{ fontSize: "0.58rem", color: "#94a3b8", marginTop: 2, lineHeight: 1.2 }}>
                All games<br />({stats.allGames.total.toLocaleString()} tracked)
              </div>
            </div>
...
// ------------------------------------------------------------
// RESPONSIVE NAV GRID — 2 cols on mobile, 3 on desktop
// ------------------------------------------------------------
  ...
  return (
    <>
      <style>{`
        ...
        /* Today's Picks (premium) always spans full width on mobile */
        .nav-card-grid .premium-card-wrapper {
          grid-column: 1 / -1;
        }
    ...
    <div className="mb-4">
      ...
      {league === "ncaa" && (
        <>
          ...
          {/* NCAA nav cards — 2-col mobile, 3-col desktop */}
          <NavCardGrid>
        ...
        <>
          ...
          <div style={{ backgroundColor: "#f0fdf4", border: "1px solid #86efac", borderRadius: 8, padding: "0.75rem 1rem", marginBottom: "1.25rem", display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "0.75rem", flexWrap: "wrap" }}>
            <span style={{ fontSize: "0.82rem", color: "#15803d" }}>
              🏫 <strong>WIAA Basketball</strong> — BBMI correctly predicts WIAA winners <strong>{wiaaStats.winPct}%</strong> of the time across {wiaaStats.total.toLocaleString()}+ games.
            </span>
          ...
          {/* WIAA nav cards — 2-col mobile, 3-col desktop */}
          <NavCardGrid>
