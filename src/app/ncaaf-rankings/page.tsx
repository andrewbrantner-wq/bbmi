...
const TOOLTIPS: Record<string, string> = {
  model_rank:       "BBMI's proprietary model rank — built on SP+ efficiency ratings, yards per play differential, turnover margin, quality wins, and home field advantage. This is the primary ranking used for BBMI's picks and spread predictions.",
  bbmif:            "The raw BBMI score — a composite efficiency rating that drives the model rank. Higher is better.",
...
export default function FootballRankingsPage() {
  ...
  useEffect(() => {
    const jsonLd = {
      ...
      name: "BBMI NCAA Football Rankings",
                ...
                <table style={{ borderCollapse: "collapse", width: "100%", tableLayout: "auto", minWidth: 780 }}>
                  ...
                  <thead>
                    <tr>
                      ...
                      <SortableHeader label="BBMI"      columnKey="bbmif"             tooltipId="bbmif"           align="center" {...headerProps} />
