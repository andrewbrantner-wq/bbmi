...
const STAT_CARDS: StatCardData[] = [
  ...
  { sportLabel: "MLB", color: "#78716c", value: "\u2014", metric: "Away +1.5 ATS", sub: "walk-forward under revision", note: "Cell-definition audit in progress \u00B7 numbers pending", href: "/mlb/picks" },
