        ...
        <div style={{ backgroundColor: "#ffffff", padding: "20px 24px", borderTop: "1px solid #d6d3d1", fontSize: 14, color: "#44403c", lineHeight: 1.65 }}>
          {mode === "rl" ? (
            ...
            <>
              ...
              <p style={{ fontSize: 12, color: "#78716c", marginTop: 10, marginBottom: 0 }}>Walk-forward validation (2024-2025): Under picks at 56.7% ATS on 630 games. ROI: +8.2% at {OU_JUICE} juice. Past performance does not guarantee future results.</p>
            </>
          )}
        </div>
      )}
        ...
        <div style={{ padding: "1.25rem 1.5rem" }}>
          ...
          <div style={itemStyle}>
            ...
            <div>
              ...
              <p style={descStyle}>Games where the model total is {"\u2265"} 0.83 runs below the posted line generate under recommendations. Walk-forward: 56.7% ATS on 630 games (2024-2025). ROI: +8.2% at standard {OU_JUICE} juice.</p>
            </div>
          </div>
