// This is the component that shows the paywall when users aren't premium
// Place this wherever you check if user is premium and need to show upgrade options

export default function PremiumContentPaywall({ userEmail }: { userEmail: string }) {
  return (
    <div style={{
      minHeight: '100vh',
      display: 'flex',
